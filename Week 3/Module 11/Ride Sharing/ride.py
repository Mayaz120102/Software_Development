...
class RideSharing:
    ...
    def __str__(self):
        return f"Company Name {self.company_name} with ridres: {len(self.riders)} and Drivers: {len(self.drivers)}"
...
class Ride:
    ...
    def __repr__(self):
        return f"Ride ddetails. Started {self.start_location} to {self.end_location}"
